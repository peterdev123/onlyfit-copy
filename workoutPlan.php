...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-light">
      ...
      <table class="table2">
            <tr>
                <th colspan="2" class="th1" style="text-align: center; font-size: 30px;">Select Workout Plans</th>
            </tr>
            <tr>
                <td class="td1" style="width: 50%;"><a href="pushPlan.php" class="button">Push Workout Plan</a></td>
                <td class="td1"><a href="pullPlan.php" class="button">Pull Workout Plan</a></td>
            </tr>
            <tr>
                <td class="td1"> <a href="legPlan.php" class="button">Leg Workout Plan</a></td>
                <td class="td1"><a href="calisthenicsPlan.php" class="button">Calisthenics Workout Plan</a></td>
            </tr>
            <tr>
                <td class="td1" colspan="2"><a href="customPlan.php" class="button">Make Custom Workout Plan</a></td>
